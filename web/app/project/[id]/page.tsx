  ...
  if (loading) {
    return (
      <div className="flex h-screen bg-[#0A0A0A]">
        <Sidebar activePage="project" onCreateProject={() => router.push('/dashboard')} />
      ...
      <main className="flex-1 flex flex-col min-w-0">
        <header className="px-6 py-4 border-b border-[rgba(255,255,255,0.06)] flex-shrink-0">
          <p className="text-xs text-[#666666] mb-1">
            <button onClick={() => router.push('/dashboard')} className="hover:text-[#A1A1A1] transition-colors">Projects</button>
